...
public class manageReviewController implements Initializable {
	...
	// ======================= 관리자 리뷰창 ======================= // 
	   ...
	   @FXML
	   private RadioButton caseRdo1;
	   @FXML
	   private RadioButton caseRdo2;
	   @FXML
	   private RadioButton caseRdo3;
	   @FXML
	   private RadioButton caseRdo4;
	   @FXML
	   private RadioButton caseRdo5;
	   @FXML
	   private RadioButton mbRdo1;
	   @FXML
	   private RadioButton mbRdo2;
	   @FXML
	   private RadioButton mbRdo3;
	   @FXML
	   private RadioButton mbRdo4;
	   @FXML
	   private RadioButton mbRdo5;
	   @FXML
	   private RadioButton pwRdo1;
	   @FXML
	   private RadioButton pwRdo2;
	   @FXML
	   private RadioButton pwRdo3;
	   @FXML
	   private RadioButton pwRdo4;
	   @FXML
	   private RadioButton pwRdo5;
	   @FXML
	   private RadioButton ramRdo1;
	   @FXML
	   private RadioButton ramRdo2;
	   @FXML
	   private RadioButton ramRdo3;
	   @FXML
	   private RadioButton ramRdo4;
	   @FXML
	   private RadioButton ramRdo5;
	   @FXML
	   private RadioButton cpuRdo1;
	   @FXML
	   private RadioButton cpuRdo2;
	   @FXML
	   private RadioButton cpuRdo3;
	   @FXML
	   private RadioButton cpuRdo4;
	   @FXML
	   private RadioButton cpuRdo5;
	   @FXML
	   private RadioButton vgaRdo1;
	   @FXML
	   private RadioButton vgaRdo2;
	   @FXML
	   private RadioButton vgaRdo3;
	   @FXML
	   private RadioButton vgaRdo4;
	   @FXML
	   private RadioButton vgaRdo5;
	   @FXML
	   private RadioButton hddRdo1;
	   @FXML
	   private RadioButton hddRdo2;
	   @FXML
	   private RadioButton hddRdo3;
	   @FXML
	   private RadioButton hddRdo4;
	   @FXML
	   private RadioButton hddRdo5;
	   @FXML
	   private RadioButton ssdRdo1;
	   @FXML
	   private RadioButton ssdRdo2;
	   @FXML
	   private RadioButton ssdRdo3;
	   @FXML
	   private RadioButton ssdRdo4;
	   @FXML
	   private RadioButton ssdRdo5;
	   ...
	   public void tabEvent() {
	      caseRdo2.setOnAction(new EventHandler<ActionEvent>() {
	         
	         @Override
	         public void handle(ActionEvent event) {
	            
	               System.out.println(caseRdo2.isSelected());
	               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId2.getText());
	               caseId2.setText("");
	               caseTxt2.setText("");
	      ...
	      caseRdo3.setOnAction(new EventHandler<ActionEvent>() {
		         
		         @Override
		         public void handle(ActionEvent event) {
		            
		               System.out.println(caseRdo2.isSelected());
		               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId3.getText());
		               caseId3.setText("");
		               caseTxt3.setText("");
		             
		         }
		      });
	      caseRdo4.setOnAction(new EventHandler<ActionEvent>() {
		         
		         @Override
		         public void handle(ActionEvent event) {
		            
		               System.out.println(caseRdo2.isSelected());
		               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId4.getText());
		               caseId4.setText("");
		               caseTxt4.setText("");
	      ...
	      caseRdo5.setOnAction(new EventHandler<ActionEvent>() {
		         
		         @Override
		         public void handle(ActionEvent event) {
		            
		               System.out.println(caseRdo2.isSelected());
		               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId5.getText());
		               caseId5.setText("");
		               caseTxt5.setText("");
	      ...
	      caseMyId.setText("master");
	      mbMyId.setText("master");
	      pwMyId.setText("master");
	      ramMyId.setText("master");
	      cpuMyId.setText("master");
	      vgaMyId.setText("master");
	      hddMyId.setText("master");
	      ssdMyId.setText("master");
...
//	            System.out.println(list.get(0).getMemberID());
	      ...
	      caseDelete.setOnMouseClicked(new EventHandler<Event>() {
	         ...
	         public void handle(Event event) {/////////// 삭제버튼
	            ...
	            caseMyId.setText("");
	            caseMyTxt.setText("");
	            if(caseRdo1.isSelected() == true) {
	               System.out.println(caseRdo1.isSelected());
	               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId1.getText());
	               caseId1.setText("");
	               caseTxt1.setText("");
	            }
	            if(caseRdo2.isSelected() == true) {
	               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId2.getText());
	               caseId2.setText("");
	               caseTxt2.setText("");
	            }
	            if(caseRdo3.isSelected() == true) {
	               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId3.getText());
	               caseId3.setText("");
	               caseTxt3.setText("");
	            }
	            if(caseRdo4.isSelected() == true) {
	               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId4.getText());
	               caseId4.setText("");
	               caseTxt4.setText("");
	            }
	            if(caseRdo5.isSelected() == true) {
	               ReviewDAO.deleteReviewDataManage(caseComboBox.getValue(),caseId5.getText());
	               caseId5.setText("");
	               caseTxt5.setText("");
	            }
